...
builder.Services.AddTransient<ProcessSyncTransactionInterface,DALC>();
builder.Services.AddTransient<Datavalidator, VaildateRequest>();
builder.Services.AddTransient<TransactionRecords, DALC>();
builder.Services.AddTransient<Commondetail,Commondetails>();
